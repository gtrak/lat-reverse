...
3. Launch a `Task` explore subagent to examine the given scope. Include the workflow contents in its prompt. Tell it: "Return a summary of what this code does, its responsibilities, and any invariants you can observe."
